...
urlpatterns = [
    ...
    path('prescribed/medicine/remove/<treatment_id>/<pres_id>/<pm_id>/', RemovePrescribedMedicine.as_view(), name='prescribed-medicine-remove'),
    path('prescription/confirm/<treatment_id><pres_id>/', ConfirmPrescription.as_view(), name='confirm-prescription'),
]